                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">
                                    ...
                                    Add new <a href="{{ url('add-category') }}" class="text-primary m-lg-1">Category</a>
                                </h4>
                                <p class="card-title-desc"></p>
                                <form class="needs-validation" novalidate action="{{ route('store-category') }}"
                                    method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                    id="validationCustom01" placeholder="category name" required>
