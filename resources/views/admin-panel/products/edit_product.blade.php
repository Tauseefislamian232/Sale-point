                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h2 class="card-title-desc">
                                    <p class="card-title">Edit Product Details</p>
                                </h2>
                                <form id="form1" novalidate method="POST"
                                    action="{{ url('update-product/' . $data->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="form-group">
                                                <label class="radio m-lg-3">
                                                    <input type="radio" name="is_drink" value="0" {{ $data->is_drink == '0' ? 'checked' : ''}}>
                                                    Drink Kitchen
                                                </label>
                                                <label class="radio m-lg-3">
                                                    <input type="radio" name="is_drink" value="1" {{ $data->is_drink == '1' ? 'checked' : ''}}>
                                                    Food Kitchen
                                                </label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control" name="course" id="course">
                                                ...
                                                @foreach ($data->category->subcategory as $sub_cat)
                                                    <option value="{{$sub_cat->id}}" {{($data->subcat_id == $sub_cat->id) ? "selected" : ""}}>
                                                        {{$sub_cat->name}}
                                                    </option>
                                                @endforeach
                                            </select>
